...
d_fin$outcome <- paste(d_fin$study,  d$resource, sep="_") # 7 outcomes in total, different shellfish
...
d_fin$age_lower <- 10 # only if interval ages given
d_fin$age_upper <- 16 # only if interval ages given; from text: "During the 8-day trip, direct observations of a total of six children (three children for each sex) were conducted. The ages of the three boys were estimated at 12, 14, and 16 years old. The three girls were estimated to be 10, 13, and 15 years old."
d_fin$resource <- "small_game" # what type of foraging resource
d_fin$units <- "g/6days" # whether the rate is per hour (hr), per day, or other
