...
temp_dir <- "paper_data_round2/Hawkes_1995/Table_5" # temporarily set directory
setwd(temp_dir)
...
d_fin$id <-  NA # 
d_fin$sex <- d_all$sex                    # all age info assume data used are those presented in table 2
d_fin$age <- d_all$age_mean               # from table 2
d_fin$age_error <- NA # 
d_fin$age_sd <- d_all$age_sd              # from table 2
d_fin$age_lower <- d_all$age_lower        # from table 2
d_fin$age_upper <- d_all$age_upper        #  from table 2
