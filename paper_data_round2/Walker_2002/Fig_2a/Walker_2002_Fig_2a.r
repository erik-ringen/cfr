...
temp_dir <- "paper_data_round2/Walker_2002/Fig_2a" # temporarily set directory
...
#### Step 1: Wrangle data ########
d <- bind_rows( d_list$scatterplot$`Fig_2a LOWESS curves fitted to return rates for 78 individuals hunters (1392 hunter days) across the lifespan separated by decade..png`  ) %>% select(id, x, y)
